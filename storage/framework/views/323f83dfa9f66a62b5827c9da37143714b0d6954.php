...
<!--                                </div>-->
                                ...
                                <div id="combo" class="col-md-9 mb-1">
                                    <label><?php echo e(trans('Agregar Producto')); ?></label>
                                    <div class="search-box input-group mb-3">
                                        <button class="btn btn-secondary"><i class="fa fa-barcode"></i></button>
                                        <input type="text" name="product_code_name" id="lims_productcodeSearch" placeholder="Please type product code and select..." class="form-control" />
                                    </div>
                                    <label><?php echo e(trans('Kit Productos')); ?></label>
                                ...
                                <div id="alert-qty" class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Cantidad de alerta')); ?></strong> </label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Detalles del producto')); ?></label>
                                ...
                                <div class="col-md-12" id="variant-section">
                                    <div class="col-md-6 form-group mt-2">
                                        <input type="text" name="variant" class="form-control" placeholder="<?php echo e(trans('Introduzca las variantes por comas')); ?>">
                                    </div>
                                        ...
                                        <table id="variant-table" class="table table-hover variant-list">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo e(trans('Código del objeto')); ?></th>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4" id="last_date">
                                            <div class="form-group">
                                                <label><?php echo e(trans('Finaliza la promoción')); ?></label>
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text"><i class="dripicons-calendar"></i></div>
                                                    </div>
                            ...
                            <div class="form-group">
                                <input type="button" value="<?php echo e(trans('Enviar')); ?>" id="submit-btn" class="btn btn-primary">
                            </div>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mario Montero\ERP_contable_laravel\resources\views/product/create.blade.php ENDPATH**/ ?>
