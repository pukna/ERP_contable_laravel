...
<section class="forms">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select required name="warehouse_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Seleccionar bodega...">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="supplier_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Seleccionar proveedor...">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Estado de compra')); ?></label>
                                            <select name="status" class="form-control">
                                                <option value="1"><?php echo e(trans('Recivido')); ?></option>
                                                <option value="2"><?php echo e(trans('Parcial')); ?></option>
                                                <option value="3"><?php echo e(trans('Pendiente')); ?></option>
                                                <option value="4"><?php echo e(trans('Ordenado')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="recieved-product-qty d-none"><?php echo e(trans('Recivido')); ?></th>
                                                    <th><?php echo e(trans('Costo unitario neto')); ?></th>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Pedido de impuestos')); ?></label>
                                            <select class="form-control" name="order_tax_rate">
                                                <option value="0"><?php echo e(trans('No impesto')); ?></option>
    ...
    <div class="container-fluid">
        <table class="table table-bordered table-condensed totals">
            <td><strong><?php echo e(trans('Objeto')); ?></strong>
                <span class="pull-right" id="item">0.00</span>
            </td>
            <td><strong><?php echo e(trans('file.Total')); ?></strong>
                <span class="pull-right" id="subtotal">0.00</span>
            </td>
            <td><strong><?php echo e(trans('Orden de impuesto')); ?></strong>
            ...
            <td><strong><?php echo e(trans('Gran Total')); ?></strong>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label><?php echo e(trans('Costo Unitario')); ?></label>
                        ...
                        ?>
                        <div class="form-group">
                            <label><?php echo e(trans('Tasa de impuesto')); ?></label>
                        ...
                        <div class="form-group">
                            <label><?php echo e(trans('Unidad del producto')); ?></label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mario Montero\ERP_contable_laravel\resources\views/purchase/create.blade.php ENDPATH**/ ?>