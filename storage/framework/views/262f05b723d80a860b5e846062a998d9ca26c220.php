            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('Agregar Transferencia')); ?></h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="from_warehouse_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Seleccione Almacén...">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control selectpicker">
                                                ...
                                                <option value="3"><?php echo e(trans('Enviar')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Costo de envío')); ?></label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label><?php echo e(trans('Coste unitario')); ?></label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mario Montero\ERP_contable_laravel\resources\views/transfer/create.blade.php ENDPATH**/ ?>
