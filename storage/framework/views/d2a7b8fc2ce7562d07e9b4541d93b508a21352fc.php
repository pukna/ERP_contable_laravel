            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('Agregar ajuste')); ?></h4>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required id="warehouse_id" name="warehouse_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Seleccione Bodega...">
                                            ...
                                            <input type="hidden" name="stock_count_id" value="<?php echo e($id); ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Adjuntar documento')); ?></label>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                	<?php $__currentLoopData = $names; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                	<tr>
                                                	<td><?php echo e($name); ?></td>
                                                	<td><?php echo e($code[$key]); ?></td>
                                                	<td><input type="number" class="form-control qty" name="qty[]" value="<?php echo e($qty[$key]); ?>" required step="any" /></td>
                                                	<td class="action">
                                                		<select name="action[]" class="form-control act-val">
                                                			<?php if($action[$key] == '+'): ?>
                                                			<option value="+"><?php echo e(trans("fSuma")); ?></option>
                                                			<option value="-"><?php echo e(trans("Resta")); ?></option>
                                                			<?php else: ?>
                                                			<option value="-"><?php echo e(trans("Resta")); ?></option><option value="+"><?php echo e(trans("Suma")); ?></option>
                                                			<?php endif; ?>
                                                		</select>
                                                	</td>
                                                	<td><button type="button" class="ibtnDel btn btn-md btn-danger"><?php echo e(trans("Eliminar")); ?></button>
                                                	<input type="hidden" class="product-code" value="<?php echo e($code[$key]); ?>" />
                                                	<input type="hidden" class="product-id" name="product_id[]" value="<?php echo e($product_id[$key]); ?>" />
                                                	</td>
                                                	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                	</tr>
                                                </tbody>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mario Montero\ERP_contable_laravel\resources\views/stock_count/qty_adjustment.blade.php ENDPATH**/ ?>
