...
<section class="forms">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('Actualizar Compra')); ?></h4>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Número de referencia')); ?></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control">
                                                <option value="1"><?php echo e(trans('Recibido')); ?></option>
                                        ...
                                        <div class="table-responsive mt-3">
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="recieved-product-qty d-none"><?php echo e(trans('Recibido')); ?></th>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="order_tax_rate">
                                                <option value="0"><?php echo e(trans('No aplica')); ?></option>
    ...
    <div class="container-fluid">
        <table class="table table-bordered table-condensed totals">
            ...
            <td><strong><?php echo e(trans('Subtotal')); ?></strong>
                <span class="pull-right" id="subtotal">0.00</span>
            </td>
            <td><strong><?php echo e(trans('iva')); ?></strong>
                <span class="pull-right" id="order_tax">0.00</span>
            </td>
            <td><strong><?php echo e(trans('Descuento')); ?></strong>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mario Montero\ERP_contable_laravel\resources\views/purchase/edit.blade.php ENDPATH**/ ?>