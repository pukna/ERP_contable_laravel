            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('Configuración general')); ?></h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Título del sitio')); ?> *</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Logotipo del sitio')); ?></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Moneda')); ?> *</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Posición de moneda')); ?> *</label><br>
                                        <?php if($lims_general_setting_data->currency_position == 'prefix'): ?>
                                        <label class="radio-inline">
                                            <input type="radio" name="currency_position" value="prefix" checked> <?php echo e(trans('Prefijo')); ?>

                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio" name="currency_position" value="suffix"> <?php echo e(trans('Sufijo')); ?>

                                        </label>
                                        <?php else: ?>
                                        <label class="radio-inline">
                                            <input type="radio" name="currency_position" value="prefix"> <?php echo e(trans('Prefijo')); ?>

                                        </label>
                                        <label class="radio-inline">
                                          <input type="radio" name="currency_position" value="suffix" checked> <?php echo e(trans('Sufijo')); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Zona horaria')); ?></label>
                                ...
                                <div class="col-md-6 d-none">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Tema')); ?> *</label>
                                        <div class="row ml-1">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Acceso del personal')); ?> *</label>
                                        <?php if($lims_general_setting_data): ?>
                                        ...
                                        <select name="staff_access" class="selectpicker form-control">
                                            <option value="all"> <?php echo e(trans('Todos los registros')); ?></option>
                                            <option value="own"> <?php echo e(trans('Registros Propios')); ?></option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Formato de fecha')); ?> *</label>
                                        <?php if($lims_general_setting_data): ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mario Montero\ERP_contable_laravel\resources\views/setting/general_setting.blade.php ENDPATH**/ ?>
