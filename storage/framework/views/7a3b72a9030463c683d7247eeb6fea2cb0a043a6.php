            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('Actualizar Venta')); ?></h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Referencia')); ?></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select required name="customer_id" class="selectpicker form-control" data-live-search="true" id="customer-id" data-live-search-style="begins" title="Seleccione Cliente...">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Facturador')); ?> *</label>
...
<!--                                            <button type="button" class="btn btn-secondary btn-lg"><i class="fa fa-barcode"></i></button>-->
                                ...
                                <div class="row mt-5">
                                    <div class="col-md-12">
                                        <h5><?php echo e(trans('Tabla de pedidos')); ?> *</h5>
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><?php echo e(trans('Precio unitario neto')); ?></th>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td><button type="button" class="ibtnDel btn btn-md btn-danger"><?php echo e(trans("Eliminar")); ?></button></td>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <label><?php echo e(trans('Iva')); ?></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong><?php echo e(trans('Descuento')); ?></strong>
                                            </label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong><?php echo e(trans('Costo de envio')); ?></strong>
                                            </label>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Adjuntar documento')); ?></label> <i class="dripicons-question" data-toggle="tooltip" title="Only jpg, jpeg, png, gif, pdf, csv, docx, xlsx and txt file is supported"></i>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Estado de venta')); ?> *</label>
                                            <input type="hidden" name="sale_status_hidden" value="<?php echo e($lims_sale_data->sale_status); ?>" />
                                            <select name="sale_status" class="form-control">
                                                <option value="1"><?php echo e(trans('Completado')); ?></option>
                                                <option value="2"><?php echo e(trans('Pendiente')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                    <?php if($lims_sale_data->coupon_id): ?>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong><?php echo e(trans('Cupón de descuento')); ?></strong>
                                            </label>
    ...
    <div class="container-fluid">
        <table class="table table-bordered table-condensed totals">
                <td><strong><?php echo e(trans('Elementos')); ?></strong>
                <span class="pull-right" id="item">0.00</span>
            </td>
            <td><strong><?php echo e(trans('file.Total')); ?></strong>
                <span class="pull-right" id="subtotal">0.00</span>
            </td>
            <td><strong><?php echo e(trans('Iva')); ?></strong>
                <span class="pull-right" id="order_tax">0.00</span>
            </td>
            <td><strong><?php echo e(trans('Orden de descuanto')); ?></strong>
                <span class="pull-right" id="order_discount">0.00</span>
            </td>
            <td><strong><?php echo e(trans('Costo de envío')); ?></strong>
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <label><?php echo e(trans('Cantidad')); ?></label>
                            <input type="number" name="edit_qty" class="form-control" step="any">
                        </div>
                        <div class="form-group">
                            <label><?php echo e(trans('Descuento por unidad')); ?></label>
                            <input type="number" name="edit_discount" class="form-control" step="any">
                        </div>
                        <div class="form-group">
                            <label><?php echo e(trans('Precio unitario')); ?></label>
                        ...
                        ?>
                            <div class="form-group">
                                <label><?php echo e(trans('Tasa de impuestos')); ?></label>
                            ...
                            <div id="edit_unit" class="form-group">
                                <label><?php echo e(trans('Unidad de producto')); ?></label>
    ...
    <div id="cash-register-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-header">
              <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('Añadir caja registradora')); ?></h5>
              <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
              <p class="italic"><small><?php echo e(trans('Las etiquetas de campo marcadas con * son campos de entrada obligatorios')); ?>.</small></p>
                <div class="row">
                  ...
                  <div class="col-md-6 form-group">
                      <label><?php echo e(trans('Efectivo en mano')); ?> *</strong> </label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mario Montero\ERP_contable_laravel\resources\views/sale/edit.blade.php ENDPATH**/ ?>
