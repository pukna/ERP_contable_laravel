...
<section class="forms">
    <div class="container-fluid">
        <h3><?php echo e(trans('Estado de cuenta')); ?></h3>
        <strong><?php echo e(trans('Cuenta')); ?>:</strong> <?php echo e($lims_account_data->name); ?> [<?php echo e($lims_account_data->account_no); ?>]
    </div>
        ...
        <table id="account-table" class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('Debito')); ?></th>
                    <th><?php echo e(trans('Balance')); ?></th>
                </tr>
            </thead>
            <tbody>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mario Montero\ERP_contable_laravel\resources\views/account/account_statement.blade.php ENDPATH**/ ?>
