            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('Permiso de grupo')); ?></h4>
                    </div>
						            	...
						            	<span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="account-index" class="padding05"><?php echo e(trans('Cuentas')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="money-transfer" class="padding05"><?php echo e(trans('Trasferencia de dinero')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="balance-sheet" class="padding05"><?php echo e(trans('Balance General')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
						                    	<div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="account-statement-permission" class="padding05"><?php echo e(trans('Estado de Cuenta')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                    </td>
						            	...
						            	<span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="profit-loss" class="padding05"><?php echo e(trans('Informe resumido')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <!--						                <span>-->
                                        ...
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="monthly-sale" class="padding05"><?php echo e(trans('Venta Mensual')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <!--						                <span>-->
                                        ...
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
						                    	<div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="monthly-purchase" class="padding05"><?php echo e(trans('Compas Mensuales')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="product-report" class="padding05"><?php echo e(trans('Reporte de productos')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="payment-report" class="padding05"><?php echo e(trans('Reporte de pagos')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="purchase-report" class="padding05"> <?php echo e(trans('Reporte de compras')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="sale-report" class="padding05"><?php echo e(trans('reporte de ventas')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
						                    	<div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="warehouse-report" class="padding05"><?php echo e(trans('Reporte de bodega')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
						                    	<div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="warehouse-stock-report" class="padding05"><?php echo e(trans('Existencia en bodega')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
						                    	<div class="checkbox">
							                    	...
							                    	<?php endif; ?>
													<label for="product-qty-alert" class="padding05"><?php echo e(trans('Alertas de productos')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
								        </span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="user-report" class="padding05"><?php echo e(trans('Reporte de usuario')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="customer-report" class="padding05"><?php echo e(trans('Reporte de clientes')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="Supplier-report" class="padding05"><?php echo e(trans('Reporte de proveedores')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="due-report" class="padding05"><?php echo e(trans('Informes Vencidos')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                    </td>
                                        ...
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="warehouse" class="padding05"><?php echo e(trans('Bodega')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="customer_group" class="padding05"><?php echo e(trans('Grupo de clientes')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
								            <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="brand" class="padding05"><?php echo e(trans('Marcas')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
								            <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="unit" class="padding05"><?php echo e(trans('Unidades')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
								            <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="tax" class="padding05"><?php echo e(trans('Impuestos')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="general_setting" class="padding05"><?php echo e(trans('Configuración general')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <!--						                <span>-->
						            	...
						            	<span>
								            <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="category" class="padding05"><?php echo e(trans('Categoria')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						            	</span>
                                        <span>
						            		<div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="delivery" class="padding05"><?php echo e(trans('Entrega')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						            	</span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="stock_count" class="padding05"><?php echo e(trans('Recuento stock')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="adjustment" class="padding05"><?php echo e(trans('Ajuste')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <!--						                <span>-->
                                        ...
                                        <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<?php endif; ?>
								                    <label for="empty_database" class="padding05"><?php echo e(trans('Vaciar BDD')); ?> &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
                                        <!--						                <span>-->
