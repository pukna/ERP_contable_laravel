...
<section>
    <div class="container-fluid">
        <a href="<?php echo e(route('qty_adjustment.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(trans('Add Tranferencia')); ?></a>
    </div>
        ...
        <table id="adjustment-table" class="table purchase-list">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('Refecencia')); ?></th>
                    <th><?php echo e(trans('Almacen')); ?></th>
                    <th><?php echo e(trans('Producto')); ?>s</th>
                    <th><?php echo e(trans('ota')); ?></th>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <a href="<?php echo e(route('qty_adjustment.edit', ['id' => $adjustment->id])); ?>" class="btn btn-link"><i class="dripicons-document-edit"></i> <?php echo e(trans('Edtar')); ?></a>
                                </li>
                                <li class="divider"></li>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mario Montero\ERP_contable_laravel\resources\views/adjustment/index.blade.php ENDPATH**/ ?>
