                    ...
                    <li><a href="#purchase" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-card"></i><span><?php echo e(trans('Compra')); ?></span></a>
                        <ul id="purchase" class="collapse list-unstyled ">
                            ...
                            <?php if($add_permission_active): ?>
                                ...
                                <li id="purchase-import-menu"><a><?php echo e(trans('Registro factura')); ?></a></li>
                            <?php endif; ?>
...
<div class="page">
    ...
    <div id="account-statement-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('Estado de Cuenta')); ?></h5>
                    <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                </div>
                <div class="modal-body">
                    <p class="italic"><small><?php echo e(trans('Las etiquetas de campo marcadas con * son campos de entrada obligatorios')); ?>.</small></p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select class="form-control selectpicker" name="type">
                                <option value="0"><?php echo e(trans('Todas')); ?></option>
                                <option value="1"><?php echo e(trans('Debito')); ?></option>
                                <option value="2"><?php echo e(trans('Credito')); ?></option>
                            </select>
                        </div>
                        <div class="col-md-12 form-group">
                            <label><?php echo e(trans('Elija la fecha')); ?></label>
