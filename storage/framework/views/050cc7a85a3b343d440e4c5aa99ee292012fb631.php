...
<section class="forms">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('Agregar cotización')); ?></h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Proveedor')); ?></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="customer_id" name="customer_id" required class="selectpicker form-control" data-live-search="true" id="customer-id" data-live-search-style="begins" title="Seleccione cliente...">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Almacen')); ?> *</label>
                                            <select id="warehouse_id" name="warehouse_id" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Seleccione almacen...">
		                                    ...
		                                    <table id="myTable" class="table table-hover order-list">
		                                        <thead>
		                                            <tr>
                                                        ...
                                                        <th><?php echo e(trans('Decuento')); ?></th>
		                        ...
		                        <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Impuesto de pedido')); ?></label>
                                            <select class="form-control" name="order_tax_rate">
                                                <option value="0"><?php echo e(trans('No impuesto')); ?></option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Orden de deuento')); ?></label>
                                            <input type="number" name="order_discount" class="form-control" step="any">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Costo Envio')); ?></label>
                                	...
                                	<div class="col-md-4">
                                		<div class="form-group">
                                			...
                                			<select class="form-control" name="quotation_status">
                                				<option value="1"><?php echo e(trans('Pendiente')); ?></option>
                                				<option value="2"><?php echo e(trans('Enviado')); ?></option>
                                			</select>
                                		</div>
                                	</div>
                                	<div class="col-md-4">
                                		<div class="form-group">
                                			<label><?php echo e(trans('Adjuantar Documento')); ?></label>
    ...
    <div class="container-fluid">
        <table class="table table-bordered table-condensed totals">
            <td><strong><?php echo e(trans('Onjetos')); ?></strong>
                <span class="pull-right" id="item">0.00</span>
            </td>
            <td><strong><?php echo e(trans('file.Total')); ?></strong>
                <span class="pull-right" id="subtotal">0.00</span>
            </td>
            <td><strong><?php echo e(trans('Ipuesto de orden')); ?></strong>
                <span class="pull-right" id="order_tax">0.00</span>
            </td>
            <td><strong><?php echo e(trans('Orden de descuento')); ?></strong>
                <span class="pull-right" id="order_discount">0.00</span>
            </td>
            <td><strong><?php echo e(trans('Costo de envio')); ?></strong>
    ...
    <div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog">
            ...
            ?>
                            ...
                            <button type="button" name="update_btn" class="btn btn-primary"><?php echo e(trans('Actualizar')); ?></button>
                    </form>
                </div>
            </div>
        </div>
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(flag){
                ...
                cols += '<td><button type="button" class="ibtnDel btn btn-md btn-danger"><?php echo e(trans("Eliminar")); ?></button></td>';
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mario Montero\ERP_contable_laravel\resources\views/quotation/create.blade.php ENDPATH**/ ?>
