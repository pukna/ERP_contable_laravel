            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('Agregar Venta')); ?></h4>
                    </div>
                    <div class="card-body">
...
<!--                                    </div>-->
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong><?php echo e(trans('Orden de descuento')); ?></strong>
                                            </label>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Documento adjunto')); ?></label> <i class="dripicons-question" data-toggle="tooltip" title="Only jpg, jpeg, png, gif, pdf, csv, docx, xlsx and txt file is supported"></i>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="sale_status" class="form-control">
                                                <option value="1"><?php echo e(trans('Completa')); ?></option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('Estado del pago')); ?> *</label>
                                            <select name="payment_status" class="form-control">
                                                <option value="1"><?php echo e(trans('Pendiente')); ?></option>
                                                <option value="2"><?php echo e(trans('Adeuda')); ?></option>
                                                <option value="3"><?php echo e(trans('Parcial')); ?></option>
                                                <option value="4"><?php echo e(trans('Pagado')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
...
<!--                                                    <option value="5">Paypal</option>-->
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label><?php echo e(trans('Monto a Pagar')); ?> *</label>
    ...
    <div class="container-fluid">
        <table class="table table-bordered table-condensed totals">
            ...
            <td><strong><?php echo e(trans('Impuesto de pedido')); ?></strong>
    ...
    <div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog">
            ...
            ?>
                            <div class="form-group">
                                <label><?php echo e(trans('Taza de impuesto')); ?></label>
              ...
              <p class="italic"><small><?php echo e(trans('Las etiquetas de campo marcadas con * son campos de entrada obligatorios')); ?>.</small></p>
                <div class="row">
                  ...
                  <div class="col-md-6 form-group">
                      <label><?php echo e(trans('Dinero en efectivo')); ?> *</strong> </label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mario Montero\ERP_contable_laravel\resources\views/sale/create.blade.php ENDPATH**/ ?>
