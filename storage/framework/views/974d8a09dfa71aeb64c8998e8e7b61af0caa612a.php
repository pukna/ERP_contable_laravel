...
<section>
    <div class="container-fluid">
        <?php if(in_array("quotes-add", $all_permission)): ?>
            <a href="<?php echo e(route('quotations.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(trans('Add Cotización')); ?></a>
        <?php endif; ?>
    </div>
        ...
        <table id="quotation-table" class="table quotation-list">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('Estado de cotización')); ?></th>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <a class="btn btn-link" href="<?php echo e(route('quotations.edit', $quotation->id)); ?>"><i class="dripicons-document-edit"></i> <?php echo e(trans('Editar')); ?></a></button>
                                </li>
                                <?php endif; ?>
                                <li>
                                    <a class="btn btn-link" href="<?php echo e(route('quotation.create_sale', ['id' => $quotation->id])); ?>"><i class="fa fa-shopping-cart"></i> <?php echo e(trans('Crear Venta')); ?></a></button>
                                </li>
                                <li>
                                    <a class="btn btn-link" href="<?php echo e(route('quotation.create_purchase', ['id' => $quotation->id])); ?>"><i class="fa fa-shopping-basket"></i> <?php echo e(trans('Crear Compra')); ?></a></button>
                                </li>
                                <li class="divider"></li>
...
<script type="text/javascript">
    ...
    function quotationDetails(quotation){
        ...
        var htmlfooter = '<p><strong><?php echo e(trans("file.Note")); ?>:</strong> '+quotation[22]+'</p><strong><?php echo e(trans("Creado por")); ?>:</strong><br>'+quotation[23]+'<br>'+quotation[24];
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mario Montero\ERP_contable_laravel\resources\views/quotation/index.blade.php ENDPATH**/ ?>
