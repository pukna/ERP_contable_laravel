            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('Actualizar Producto')); ?></h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Tipo de producto')); ?> *</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Nombre del Producto')); ?> *</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Codigo de Producto')); ?> *</strong> </label>
                                        <div class="input-group">
                                            <input type="text" name="code" id="code" value="<?php echo e($lims_product_data->code); ?>" class="form-control" required>
                                            <div class="input-group-append">
                                                <button id="genbutton" type="button" class="btn btn-sm btn-default" title="<?php echo e(trans('Generar')); ?>"><i class="fa fa-refresh"></i></button>
                                            </div>
                                        </div>
...
<!--                                </div>-->
                                ...
                                <div id="combo" class="col-md-9 mb-1">
                                    <label><?php echo e(trans('Kit de Productos')); ?></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <label><?php echo e(trans('categoría')); ?> *</strong> </label>
                                        <div class="input-group">
                                ...
                                <div id="unit" class="col-md-12">
                                    <div class="row ">
                                        <div class="col-md-4">
                                                <label><?php echo e(trans('Unidad de Producto')); ?> *</strong> </label>
                                                <div class="input-group">
                                                  <select required class="form-control selectpicker" data-live-search="true" data-live-search-style="begins" title="Seleccione unidad" name="unit_id">
                                        ...
                                        <div class="col-md-4">
                                                <label><?php echo e(trans('Unidad de Venta')); ?></strong> </label>
                                                <div class="input-group">
                                        ...
                                        <div class="col-md-4 mt-2">
                                                <div class="form-group">
                                                    <label><?php echo e(trans('Unidad de Compra')); ?></strong> </label>
                                                    <div class="input-group">
                                ...
                                <div id="cost" class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Costo del Producto')); ?> *</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Precio del Producto')); ?> *</strong> </label>
                                ...
                                <div id="alert-qty" class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Alerta de Cantidad')); ?></strong> </label>
...
<!--                                </div>-->
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Detalle de Producto')); ?></label>
                                ...
                                <div class="col-md-12" id="variant-option">
                                    ...
                                    <h5><input name="is_variant" type="checkbox" id="is-variant" value="1" checked>&nbsp; <?php echo e(trans('Este producto tiene variante')); ?></h5>
                                    <?php else: ?>
                                    <h5><input name="is_variant" type="checkbox" id="is-variant" value="1">&nbsp; <?php echo e(trans('Este producto tiene variante')); ?></h5>
                                    <?php endif; ?>
                                </div>
                                <div class="col-md-12" id="variant-section">
                                    <div class="col-md-6 form-group mt-2">
                                        <input type="text" name="variant" class="form-control" placeholder="<?php echo e(trans('Ingrese la variante separada por comas')); ?>">
                                    </div>
                                        ...
                                        <table id="variant-table" class="table table-hover variant-list">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo e(trans('Código de Objeto')); ?></th>
                                                    <th><?php echo e(trans('Precio Adicional')); ?></th>
                                                    <th><i class="dripicons-trash"></i></th>
                                                </tr>
                                            </thead>
                                            <tbody>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mario Montero\ERP_contable_laravel\resources\views/product/edit.blade.php ENDPATH**/ ?>
