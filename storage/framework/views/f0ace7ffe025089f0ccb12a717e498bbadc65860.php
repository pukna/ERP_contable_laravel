<!--Actualizar transferencia almacén -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('Actualizar Transferencia')); ?></h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control selectpicker">
                                                <option value="1"><?php echo e(trans('Completo')); ?></option>
                                                <option value="2"><?php echo e(trans('Pendiente')); ?></option>
                                                <option value="3"><?php echo e(trans('Enviado')); ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo e(trans('De Almacén')); ?> *</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label><?php echo e(trans('Costo unidad')); ?></label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mario Montero\ERP_contable_laravel\resources\views/transfer/edit.blade.php ENDPATH**/ ?>
