...
class SupplierImpController extends Controller
{
    public function index()
    {
        ...
        if($role->hasPermissionTo('suppliers-index')){
            ...
            return view('supplierImp.index',compact('lims_supplier_all','lims_tax_list', 'all_permission'));
        }
        else
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('suppliers-add')){
            ...
            return view('supplierImp.create',compact('lims_bank_list'));
        }
        else
            return redirect()->back()->with('not_permitted', 'Sorry! You are not allowed to access this module');
    }
...
//        $lims_supplier_data['locate'] = 'Local';
        ...
        return redirect('supplierImp')->with('message', $message);
    }
